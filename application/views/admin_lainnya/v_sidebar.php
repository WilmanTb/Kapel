    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="<?php echo $page == 'master-data' ? 'active' : ''; ?>" id="m_master_data">
                <a href="<?php echo base_url() . 'admin_lainnya/master_data_lainnya' ?>">
            ...
            <li class="treeview <?php echo $page == 'petugas' ? 'active' : ''; ?>" id="m_petugas">
                ...
                <ul class="treeview-menu">
                    <li><a href="<?php echo base_url() . 'admin_lainnya/petugas_misa_lainnya' ?>"><i
                                class="fa fa-plus"></i> Misa </a></li>
