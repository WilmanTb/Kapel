...
<head>
  ...
  <title>List Detail Ibadah</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Detail Ibadah</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/renungan/add_renungan'?>"><span class="fa fa-plus"></span> Post Detail Ibadah</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
