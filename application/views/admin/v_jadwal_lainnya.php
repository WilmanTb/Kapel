    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form class="form-horizontal" action="<?php echo base_url() . 'admin/jadwal_lainnya/add_misa' ?>" method="post" enctype="multipart/form-data">
                    <div class="modal-body">

                        <div class="form-group">
                            <label for="inputUserName" class="col-sm-4 control-label">Nama Ibadah</label>
                            <div class="col-sm-7">
                                <input type="text" name="nama_ibadah" class="form-control" id="inputUserName" placeholder="Nama" required>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="ModalEdit<?php echo $id_ibadah; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/jadwal_lainnya/edit_misa' ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
        ...
        <div class="modal fade" id="ModalHapus<?php echo $id_ibadah; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/jadwal_lainnya/delete_misa' ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
