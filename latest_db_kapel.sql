...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 27, 2024 at 03:19 PM
...
(20, 'misa fakultas', '2024-07-26', '10.00', '1', ''),
(21, 'Misa KMKAT', '2024-08-02', '10.00', '1', ''),
(22, 'misa asrama', '2024-08-09', '10.00', '1', '');
...
(6, 'St. Nelson Simanjorang', 'nelson', '21232f297a57a5a743894a0e4a801fc3', 'nelsonsimanjorang@gmail.com', '3', '2022-06-07 08:22:46', 'b09626d24fdeb6849c1239ad7c0d0853.jpg'),
...
(46, 'Roy', 'roy', '21232f297a57a5a743894a0e4a801fc3', 'roy@gmail.com', '3', '2022-10-25 06:52:29', '8f8ad9465d979014a83e3e40d4b548a7.png'),
...
(1074, '2024-07-25 13:03:44', '::1', 'Chrome'),
(1075, '2024-07-26 14:29:37', '::1', 'Chrome'),
(1076, '2024-07-27 03:43:19', '::1', 'Chrome');
...
CREATE TABLE `tbl_reminder` (
  `id` int(11) NOT NULL COMMENT 'Primary Key',
  `nama_reminder` varchar(200) NOT NULL,
  `time_reminder` varchar(50) NOT NULL,
  `end_reminder` varchar(50) NOT NULL,
  `status_reminder` varchar(5) NOT NULL,
...
INSERT INTO `tbl_reminder` (`id`, `nama_reminder`, `time_reminder`, `end_reminder`, `status_reminder`, `create_date`, `create_by`, `ket`) VALUES
(1, 'Doa Santa Maria', '21:00', '23:59', 'N', '2024-07-06 17:19:58', 'Steffanny', 'Waktunya untuk berdoa kepada Santa Maria, ibu yang penuh kasih');
...
(23, 20, '6', NULL, NULL, NULL, NULL, NULL, NULL),
(24, 21, '2', NULL, NULL, NULL, NULL, NULL, NULL),
(25, 22, '1', '6', '7', '8,10,27,10', '27', NULL, '6,7,27,10');
...
--
ALTER TABLE `tbl_renungan`
  MODIFY `renungan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
